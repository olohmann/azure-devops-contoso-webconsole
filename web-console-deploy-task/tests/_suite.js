...
describe('Sample task tests', function () {
    ...
    it('should succeed with simple inputs', function (done) {
        ...
        // TODO assert.equal(tr.stdout.indexOf('Hello human') >= 0, true, "should display Hello human");
        done();
    });
    it('it should fail if tool returns 1', function (done) {
        ...
        // TODO assert.equal(tr.stdout.indexOf('Hello bad'), -1, "Should not display Hello bad");
        done();
    });
});
